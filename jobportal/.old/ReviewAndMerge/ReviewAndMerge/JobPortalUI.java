...
public class JobPortalUI {
    ...
    private JPanel createLoginPanel(String role) {
        ...
        loginButton.addActionListener(e -> {
            ...
            if (loginSuccess) {
                ...
                JOptionPane.showMessageDialog(frame, "Invalid credentials for " + role + ".", "Login Failed", JOptionPane.ERROR_MESSAGE);
            }
        });
    ...
    private void showForgotPassword(String role) {
        ...
        forgotFrame.add(new JLabel("Email:"), gbc); gbc.gridx = 1;
        forgotFrame.add(new JTextField(20), gbc);

        gbc.gridx = 0; gbc.gridy = ++row;
        forgotFrame.add(new JLabel("Security Question:"), gbc); gbc.gridx = 1;
        ...
        gbc.gridx = 0; gbc.gridy = ++row;
        forgotFrame.add(new JLabel("Answer:"), gbc); gbc.gridx = 1;
        forgotFrame.add(new JTextField(20), gbc);
    ...
    private void showRegistration(String role) {
        ...
        int row = 0;
        gbc.gridx = 0; gbc.gridy = row;
        regFrame.add(new JLabel("First Name:"), gbc); gbc.gridx = 1;
        regFrame.add(new JTextField(20), gbc);

        gbc.gridx = 0; gbc.gridy = ++row;
        regFrame.add(new JLabel("Last Name:"), gbc); gbc.gridx = 1;
        regFrame.add(new JTextField(20), gbc);

        if (role.equals("Recruiter")) {
            gbc.gridx = 0; gbc.gridy = ++row;
            regFrame.add(new JLabel("Company Email:"), gbc); gbc.gridx = 1;
            regFrame.add(new JTextField(20), gbc);
            gbc.gridx = 0; gbc.gridy = ++row;
            regFrame.add(new JLabel("Company Mobile:"), gbc); gbc.gridx = 1;
            regFrame.add(new JTextField(20), gbc);
        } else {
            gbc.gridx = 0; gbc.gridy = ++row;
            regFrame.add(new JLabel("Email Address:"), gbc); gbc.gridx = 1;
            regFrame.add(new JTextField(20), gbc);
            gbc.gridx = 0; gbc.gridy = ++row;
            regFrame.add(new JLabel("Mobile Number:"), gbc); gbc.gridx = 1;
            regFrame.add(new JTextField(20), gbc);
            gbc.gridx = 0; gbc.gridy = ++row;
            regFrame.add(new JLabel("Date of Birth:"), gbc); gbc.gridx = 1;
            regFrame.add(new JTextField(20), gbc);
        }

        gbc.gridx = 0; gbc.gridy = ++row;
        regFrame.add(new JLabel("Security Question:"), gbc); gbc.gridx = 1;
        ...
        gbc.gridx = 0; gbc.gridy = ++row;
        regFrame.add(new JLabel("Answer:"), gbc); gbc.gridx = 1;
        regFrame.add(new JTextField(20), gbc);

        gbc.gridx = 0; gbc.gridy = ++row;
        regFrame.add(new JLabel("Password:"), gbc); gbc.gridx = 1;
        regFrame.add(new JPasswordField(20), gbc);

        gbc.gridx = 0; gbc.gridy = ++row;
        regFrame.add(new JLabel("Confirm Password:"), gbc); gbc.gridx = 1;
        regFrame.add(new JPasswordField(20), gbc);
